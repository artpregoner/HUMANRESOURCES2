            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label for="firstName">First name</label>
                            <input type="text" class="form-control" id="firstName" value="N/A" disabled>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="lastName">Last name</label>
                            <input type="text" class="form-control" id="lastName" value="N/A" disabled>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="middlename">Middle name</label>
                            <input type="text" class="form-control" id="middlename" value="N/A" disabled>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="dateofbirth">Date of Birth</label>
                            <input type="text" class="form-control" id="dateofbirth" value="N/A" disabled>
                        </div>
                        <div class="col-md-2 mb-3">
                            <label for="gender">Gender</label>
                            <input type="text" class="form-control" id="gender" value="N/A" disabled>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="maritalstatus">Marital Status</label>
                            <input type="text" class="form-control" id="maritalstatus" value="N/A" disabled>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="bloodtype">Blood Type</label>
                            <input type="text" class="form-control" id="bloodtype" value="N/A" disabled>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <label for="phonenumber">Phone Number</label>
                            <input type="text" class="form-control" id="phonenumber" value="N/A" disabled>
                        </div>
                        <div class="col-md-5 mb-3">
                            <label for="address">Address</label>
                            <input type="text" class="form-control" id="address" value="N/A" disabled>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="state">State</label>
                            <input type="text" class="form-control" id="state" value="N/A" disabled>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="city">City</label>
                            <input type="text" class="form-control" id="city" value="N/A" disabled>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="country">Country</label>
                            <input type="text" class="form-control" id="country" value="N/A" disabled>
                        </div>
                        <div class="col-md-2 mb-3">
                            <label for="postalcode">Postal Code</label>
                            <input type="text" class="form-control" id="postalcode" value="N/A" disabled>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="nationality">Nationality</label>
                            <input type="text" class="form-control" id="nationality" value="N/A" disabled>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label for="contactnumber">Contact Number</label>
                            <input type="text" class="form-control" id="contactnumber" value="N/A" disabled>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="contactname">Contact name</label>
                            <input type="text" class="form-control" id="contactname" value="N/A" disabled>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="relationship">Relationship</label>
                            <input type="text" class="form-control" id="relationship" value="N/A" disabled>
                        </div>
                    </div>
                </div>
            </div>
