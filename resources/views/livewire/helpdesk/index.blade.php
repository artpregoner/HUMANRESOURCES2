                ...
                <form class="flex items-center">
                    ...
                    <div class="relative w-full">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                            <svg aria-hidden="true" class="w-5 h-5 text-zinc-500 dark:text-zinc-200" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd" />
                            </svg>
                        </div>
                        <input type="text" wire:model.live.debounce.500ms="search" placeholder="Search tickets..." class="block w-full p-2 pl-10 text-sm border rounded-lg text-zinc-900 border-zinc-300 bg-zinc-50 focus:ring-primary-500 focus:border-primary-500 dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-zinc-200 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search" required="">
                    </div>
                </form>
            </div>
                ...
                <tbody>
                            ...
                            <flux:modal name="delete-claim-{{ $ticket->id }}" class="min-w-[22rem]">
                                <div class="space-y-6">
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <form action="{{ route('admin.helpdesk.destroy', $ticket->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                    ...
                    @empty
                        <tr class="dark:border-zinc-600 hover:bg-zinc-100 dark:hover:bg-zinc-700">
                            <td colspan="7" class="px-4 py-3 font-medium text-center text-zinc-900 whitespace-nowrap dark:text-white">No data available</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
