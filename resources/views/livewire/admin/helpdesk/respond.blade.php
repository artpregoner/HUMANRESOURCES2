                ...
                @foreach ($responses->reverse() as $response)
                    <div class="chatbox-messages">
                        <div class="chat-message received">
                            <img src="{{ $response->user->profile_photo_path ? Storage::url($response->user->profile_photo_path) : asset('template/assets/images/avatar-1.jpg') }}"
                            alt="Avatar" class="user-avatar-lg rounded-circle">
