...
@section('content')
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            @livewire('claims.create')
        </div>
    </div>
    {{-- <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <!-- not functional but this is my updated UI -->
            <div class="card">
                ...
                <form wire:submit.prevent="submit">
                    <div class="card-body">
                            <div class="form-group">
                                ...
                                <select wire:model="currency" class="custom-select d-block w-100 col-sm-2" id="currencySelector" required>
                                    ...
                                    <div class="media influencer-profile-data d-flex align-items-center p-2">
                                        ...
                                        <div class="media-body ">
                                            <div class="influencer-profile-data">
                                                ...
                                                <p>
                                                    <span class="m-r-20 d-inline-block">24kb Document</span>
                                                </p>
                                            </div>
                                        </div>
