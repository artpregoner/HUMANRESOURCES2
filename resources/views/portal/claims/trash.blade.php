...
@section('content')
                    ...
                    <tbody>
                        @foreach ($claims as $claim)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <form action="{{ route('portal.claims.restore', $claim->id) }}" method="POST" class="d-inline">
                                            @csrf
                                        ...
                                        <form action="{{ route('portal.claims.forceDelete', $claim->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
    ...
    <div class="row">
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
            <a href="{{ route('portal.claims.index') }}" class="card-link">
                <div class="card">
                    <div class="card-body">
                        <div class="d-inline-block">
                            <h5 class="text-muted">My Claims</h5>
