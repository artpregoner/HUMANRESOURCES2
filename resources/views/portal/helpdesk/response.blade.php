        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button type="button" class="btn btn-primary btn-space" onclick="window.location.href='{{ route('helpdesk.read') }}'">
    ...
    <div class="email editor">
        <form action="{{ url('ticket.reply.store') }}" method="POST">
            ...
            <div class="action-send">
                ...
                <button type="button" class="btn btn-secondary btn-space" onclick="window.location.href='{{ route('helpdesk.read') }}'">
