    ...
    <div class="flex flex-wrap -mx-4"> {{-- Equivalent to 'row' with negative margins for column padding --}}
        <div class="w-full px-4 lg:w-full"> {{-- Equivalent to 'col-lg-12' --}}
            <div class="mb-6"> {{-- Used to be section-block, adding some bottom margin --}}
                <div class="relative flex flex-col min-w-0 break-words bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700"> {{-- Card styling --}}
                    <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 dark:bg-gray-700 dark:border-gray-600 flex justify-between items-center"> {{-- card-header d-flex --}}
                        <h4 class="text-lg font-semibold text-gray-900 dark:text-white">Employee List</h4> {{-- card-header-title --}}
                    ...
                    <div class="overflow-x-auto"> {{-- campaign-table table-responsive --}}
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400"> {{-- Flowbite table --}}
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    <th scope="col" class="px-6 py-3 whitespace-nowrap text-center">Employee Name</th> {{-- border-0, centered, nowrap --}}
                                    <th scope="col" class="px-6 py-3 whitespace-nowrap text-center">Email</th>
                                    <th scope="col" class="px-6 py-3 whitespace-nowrap text-center">Phone number</th>
                            ...
                            <tbody>
                                @foreach ($EmployeeList as $employeeRequest)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        <td class="px-6 py-4 whitespace-nowrap text-center">{{ $employeeRequest->first_name ?? 'Unknown First Name' }} {{ $employeeRequest->last_name ?? 'Unknown Last Name' }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center">{{ $employeeRequest->email }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center">{{ $employeeRequest->phone }}</td>
